<?php 
	...
	function curl_send_data($transaction){
	    ...
	    curl_setopt_array($curl, 
	        array(
	            //CURLOPT_URL => "http://103.5.148.215/gateway-bpom/services/receiveLicense", //public
				//CURLOPT_URL => "http://172.16.1.215/gateway-bpom/services/receiveLicense", //local bpom
				CURLOPT_URL => "http://172.16.1.215/dev-bpom/services/receiveLicense", //local bpom
	            CURLOPT_RETURNTRANSFER => true,
	            CURLOPT_ENCODING => "",
	            CURLOPT_MAXREDIRS => 10,
	            CURLOPT_TIMEOUT => 60,
