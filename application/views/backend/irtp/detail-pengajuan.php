	...
	<div class="col-12 card">
		...
		<div class="card-body">
			...
			<div class="row text-dark">
				...
				<div class="col-lg-6 col-sm-12">
					<div class="form-group row">
					    <label for="nama" class="col-sm-4 col-form-label"><b>Cara Penyimpanan</b></label>
					    <div class="col-sm-8">
					    	<p class="mt-1" style="text-align: justify;"><?= $irtp->cara_penyimpanan ?></p>
					    </div>
					</div>
				</div>
				<div class="col-lg-6 col-sm-12">
					<div class="form-group row">
					    <label for="nama" class="col-sm-2 col-form-label"><b>Isi Bersih	</b></label>
					    <div class="col-sm-10">
					    	<p class="mt-1" style="text-align: justify;"><?= $irtp->isi_bersih_produk ?></p>
					    </div>
					</div>
				</div>
				<div class="col-12">
			...
			<div class="row text-dark">
				...
				<div class="col-lg-4 col-sm-12">
					...
					<div class="form-group row">
					    ...
					    <div class="col-sm-2">
					    	<p class="mt-1"><?= $irtp->nama_produsen == 1 ? '<i class="fa fa-check text-success"></i>' : '<i class="fa fa-times text-danger"></i>' ?></p>
					    </div>
					</div>
					<div class="form-group row">
					    <label for="nama" class="col-sm-10 col-form-label"><b>Alamat Produsen</b></label>
					    <div class="col-sm-2">
					    	<p class="mt-1"><?= $irtp->alamat_produsen == 1 ? '<i class="fa fa-check text-success"></i>' : '<i class="fa fa-times text-danger"></i>' ?></p>
					    </div>
					</div>
