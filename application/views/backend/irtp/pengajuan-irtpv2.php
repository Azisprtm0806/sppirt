            ...
            <div class="form-wizard">
              <form class="form-pengajuan-irtp" role="form">
                <div class="form-wizard-header">
                  <p><h3>Mohon semua field diisi lengkap untuk dapat melanjutkan ke tahap berikutnya</h3></p>
                ...
                <fieldset class="wizard-fieldset show" data-wizard="1">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" style="background:#ccc" readonly class="form-control wizard-required" nama="Nama Pelaku Usaha" id="nama_pelaku_usaha" name="nama_pelaku_usaha" value="<?= $user['nama_pelaku_usaha'] ?>" placeholder="" required>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" style="background:#ccc" readonly class="form-control wizard-required" id="nik" nama="NIK" name="nik" maxlength="16" minlength="16" value="<?= $user['nik'] ?>" placeholder="" required>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" style="background:#ccc" readonly class="form-control wizard-required" nama="Nama Usaha" id="nama_usaha" name="nama_usaha" value="<?= $user['nama_usaha'] ?>" placeholder="" required>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" style="background:#ccc" readonly class="form-control wizard-required" id="nib" nama="NIB" name="nib" readonly value="<?= $user['nib'] ?>" placeholder="" required>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" onkeypress="return isNumber(event)" name="no_telp" id="no_telp" class="form-control wizard-required" nama="No Telpon" value="<?= $user['no_telp'] ?>" placeholder="">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" class="form-control wizard-required" nama="Email" value="<?= $user['email'] ?>">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <select name="id_prov" style="background:#ccc" id="id_prov" disabled class="form-control wizard-required" nama="Provinsi">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <div id="show-kab-kota">
                          <select name="id_kota" id="id_kota" style="background:#ccc" disabled class="form-control wizard-required" nama="Kab/Kota">
                            <option value="">Pilih...</option>
					...
					<div class="col-lg-12">
                      <div class="form-group" style="margin-top: 30px">
                        <label class="text-label">Alamat Usaha<font color="red"><i><sup> *</sup>Pastikan alamat usaha sudah lengkap sampai dengan <b>kecamatan, kelurahan, RT dan RW</b>. Perubahan alamat bisa <a href="<?= base_url('account')?>"><span class="text-dark" style="background:yellow">dilengkapi di sini.</span></a></i></font></label>
                        <textarea style="background:#ccc" readonly name="alamat_lengkap" id="alamat_lengkap" nama="alamat_lengkap" class="form-control wizard-required"><?= $user['alamat_usaha'] ?></textarea>
                  ...
                  <div class="form-group clearfix" style="margin-top:20px">
                    <span class="text-dark" style="background:yellow"><b>PASTIKAN KEMBALI</b> data <b>Alamat Usaha</b> <font color="red"><b>SUDAH LENGKAP!!</b></font> Untuk melengkapi Alamat Usaha dapat dilakukan <a href="<?= base_url('account')?>"><font color="red">di Sini</font></a> </span>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="250 gram, 500 gram" name="isi_bersih_produk" id="isi_bersih_produk" nama="Isi Bersih Produk" class="form-control wizard-required isi_bersih_produk">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        <label class="text-label">Ini adalah produk IRTP Anda yang ke? (otomatis terisi oleh sistem)</label>
                        <input type="number" style="background:#ccc" readonly="readonly" min="0" value="<?= $produk_ke?>" name="produk_ke" id="produk_ke" nama="Produk Ke?" class="form-control wizard-required">
                    ...
                    <div class="col-12">
                      ...
                      <table class="table">
                        <tbody>
                          ...
                          <tr>
                            <td class="text-left">8. Informasi Nilai Gizi <font color="red"><sup>*</sup></font></td>
                            <td class="text-right">
                              <div class="form-group mb-0">
						  ...
						  <tr>
                            <td class="text-left">9. Nama Produsen <font color="red"><sup>*</sup></font></td>
                            <td class="text-right">
                              <div class="form-group mb-0">
                                <label class="radio-inline" for="nama_produsen_1"><input type="radio" name="nama_produsen" id="nama_produsen_1" value="1"> Ya</label>
                                <label class="radio-inline" for="nama_produsen_0"><input type="radio" name="nama_produsen" id="nama_produsen_0" value="0"> Tidak</label>
                              </div>
                            </td>
                          </tr>
						  <tr>
                            <td class="text-left">10. Alamat Produsen <font color="red"><sup>*</sup></font></td>
                            <td class="text-right">
                              <div class="form-group mb-0">
                                <label class="radio-inline" for="alamat_produsen_1"><input type="radio" name="alamat_produsen" id="alamat_produsen_1" value="1"> Ya</label>
                                <label class="radio-inline" for="alamat_produsen_0"><input type="radio" name="alamat_produsen" id="alamat_produsen_0" value="0"> Tidak</label>
                              </div>
                            </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td class="text-left">12. Upload Rancangan Label (Format file yang diizinkan: <b>jpg, jpeg, png</b>) <font color="red"><sup>*</sup></font></td>
                            <td class="text-right">
                ...
                <fieldset class="wizard-fieldset" data-wizard="5">
                  ...
                  <div class="button-success">
                    <br>
                    <br>
                    <div class="purple-text text-center"><b>Silahkan klik tombol dibawah ini untuk untuk mengirim/ sinkronisasi data SPPIRT ke Sistem OSS</b></div>
                    <br>
                    <input type="hidden" id="id_pengajuan" name="id_pengajuan">
                    <div class="text-center"><button type="button" class="btn btn-primary" onclick="sendData2()">SINKRONISASI DATA</button></div>
                </div>
                </fieldset>
              </form>
            </div>
          ...
          success: function(response) {
            ...
            if (response.error) {
              ...
              if (response.success) {
                ...
                $('#id_pengajuan').val(response.id_pengajuan);
                $('#button-success').show();
              } else {
                $('#status').text('DITOLAK')
