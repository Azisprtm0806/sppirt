                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
						...
						<font color="red"><i>Contoh: Rumput Laut Bahari, Keripik, Rumput Laut Rasa Keju(Kemasan Plasik Pouch)</i></font>
              ...
              if(thisName == 'email'){
                ...
                if (atps<1 || dots<atps+2 || dots+2>=rs.length) {
                  ...
                  if (thisValue == "") {
                    ...
                    if (thisName == 'nama_produk_pangan' && $(`.${thisName}_error`).text()) {
                      nextWizardStep = false;
