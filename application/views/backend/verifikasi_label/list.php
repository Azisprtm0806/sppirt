            ...
            <div class="form-row form_pelaku_usaha form_dinkes">
                ...
                <div class="form-group col-md-2">
                    ...
                    <select name="status" class="form-control" id="status">
                        <option value="4"  <?php if (isset($_GET['status']) && $_GET['status'] == "4") { ?> selected <?php } ?>>Semua</option>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <?php if ($value->status_verifikasi_label == '0') { ?>
                                            <a href="<?php echo base_url(); ?>backend/verifikasi-label/verifikasi/<?php echo encrypt_decrypt('encrypt', $value->id_pengajuan); ?>" target="_blank" class="btn btn-warning btn-xs">Menunggu Perbaikan Pelaku Usaha</a>
                                        <?php }else if ($value->status_verifikasi_label == '1') { ?>
                                            <a href="<?php echo base_url(); ?>backend/verifikasi-label/verifikasi/<?php echo encrypt_decrypt('encrypt', $value->id_pengajuan); ?>" target="_blank" class="btn btn-success btn-xs">Sudah Diverifikasi</a>
                                        <?php }else if ($value->status_verifikasi_label == '2') { ?>
                                            <a href="<?php echo base_url(); ?>backend/verifikasi-label/verifikasi/<?php echo encrypt_decrypt('encrypt', $value->id_pengajuan); ?>" target="_blank" class="btn btn-warning btn-xs">Sudah Diperbaiki oleh Pelaku Usaha</a>
                                        <?php }else{ ?>
                                            <a href="<?php echo base_url(); ?>backend/verifikasi-label/verifikasi/<?php echo encrypt_decrypt('encrypt', $value->id_pengajuan); ?>" target="_blank" class="btn btn-primary btn-xs">Menunggu Diverifikasi</a>
                                        <?php } ?>
<!-- 
