            ...
            <div class="form-row form_pelaku_usaha form_dinkes">
                ...
                <div class="form-group col-md-2">
                    ...
                    <select name="status" class="form-control" id="status">
                        ...
                        <option value="2" <?php if (isset($_GET['status']) && $_GET['status'] == "2") { ?> selected <?php } ?>>Verifikasi Belum Memenuhi Komitmen</option>
                        <option value="4" <?php if (isset($_GET['status']) && $_GET['status'] == "4") { ?> selected <?php } ?>>Pengajuan Pembatalan ke PTSP</option>
                        <option value="5" <?php if (isset($_GET['status']) && $_GET['status'] == "5") { ?> selected <?php } ?>>Akun Dibekukan</option>
                        <option value="6" <?php if (isset($_GET['status']) && $_GET['status'] == "6") { ?> selected <?php } ?>>Verifikasi Ulang</option>
                    </select>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <?php if ($value->status_verifikasi_cara_pembuatan == '1') { ?>
                                            <a href="<?php echo base_url(); ?>backend/verifikasi-cara-pembuatan/verifikasi/<?php echo encrypt_decrypt('encrypt', $value->nib); ?>" target="_blank" class="btn btn-success btn-xs">Sudah Diverifikasi</a>
                                        <?php }else if ($value->status_verifikasi == '0' && $value->status_dikembalikan == NULL && $value->lokasi_produksi != '0' && $value->peralatan_otomatis == '') { ?>
                                            <a href="<?php echo base_url(); ?>backend/verifikasi-cara-pembuatan/verifikasi/<?php echo encrypt_decrypt('encrypt', $value->nib); ?>" target="_blank" class="btn btn-warning btn-xs">Verifikasi Belum Lengkap</a>
                                        <?php }else if ($value->status_verifikasi == '0' && $value->status_dikembalikan == NULL && $value->lokasi_produksi != '0' && $value->peralatan_otomatis != '1') { ?>
                                            <a href="<?php echo base_url(); ?>backend/verifikasi-cara-pembuatan/verifikasi/<?php echo encrypt_decrypt('encrypt', $value->nib); ?>" target="_blank" class="btn btn-warning btn-xs">Verifikasi Belum Memenuhi Komitmen</a>
                                        <?php }else if ($value->status_dikembalikan == '2') { ?>
                                            <a href="<?php echo base_url(); ?>backend/verifikasi-cara-pembuatan/verifikasi/<?php echo encrypt_decrypt('encrypt', $value->nib); ?>" target="_blank" class="btn btn-warning btn-xs">Pengajuan Pembatalan ke PTSP</a>
                                        <?php }else if ($value->status_dikembalikan == '1') { ?>
                                            <a href="<?php echo base_url(); ?>backend/verifikasi-cara-pembuatan/verifikasi/<?php echo encrypt_decrypt('encrypt', $value->nib); ?>" target="_blank" class="btn btn-danger btn-xs">Akun Dibekukan</a>
                                        <?php }else if ($value->status_dikembalikan == '0') { ?>
                                            <a href="<?php echo base_url(); ?>backend/verifikasi-cara-pembuatan/verifikasi/<?php echo encrypt_decrypt('encrypt', $value->nib); ?>" target="_blank" class="btn btn-primary btn-xs">Verifikasi Ulang</a>
                                        <?php }else{ ?>
                                            <a href="<?php echo base_url(); ?>backend/verifikasi-cara-pembuatan/verifikasi/<?php echo encrypt_decrypt('encrypt', $value->nib); ?>" target="_blank" class="btn btn-primary btn-xs">Menunggu Diverifikasi</a>
                                        <?php } ?>
                                    </div>
                                </td>
                            </tr>
