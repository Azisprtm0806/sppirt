                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" min="0" name="produk_ke" id="produk_ke" value="<?= $irtp->produk_ke ?>" nama="Produk Ke?" class="form-control wizard-required" >
                        <div class="wizard-form-error"></div>
                      </div>
                    </div>
                  </div>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-right">
                              ...
                              <a href="<?= base_url('uploads/labelproduk/').$irtp->upload_rancangan ?>" target="_BLANK"><?= $irtp->upload_rancangan ?></a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
...
function error(nama) {
  toastr.warning(`${nama} Tidak Boleh Kosong`, "Error", {
    timeOut: 3000,
    closeButton: !0,
    debug: !1,
    newestOnTop: !0,
