                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control wizard-required" nama="Nama Pelaku Usaha" id="nama_pelaku_usaha" name="nama_pelaku_usaha" value="<?= $pelakuusaha['nama_penanggung_jwb'] ?>"  placeholder="" required>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control wizard-required" id="nik" nama="NIK" name="nik" maxlength="16" minlength="16" value="<?= $pelakuusaha['nik_penanggung_jwb'] ?>" placeholder="" required>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control wizard-required" nama="Nama Usaha" id="nama_usaha" name="nama_usaha" value="<?= $pelakuusaha['nama_perseroan'] ?>" placeholder="" required>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control wizard-required" id="nib" nama="NIB" name="nib" readonly value="<?= $pelakuusaha['nib'] ?>" placeholder="" required>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="no_telp" id="no_telp" class="form-control wizard-required" nama="No Telpon" value="<?= $this->session->userdata('userData')['phone'] ?>" placeholder="">
                ...
                <fieldset class="wizard-fieldset">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        <label class="text-label">Ini adalah produk IRTP Anda yang ke? (contoh: 5)</label>
                        <input type="number" min="0" name="produk_ke" id="produk_ke" nama="Produk Ke?" class="form-control wizard-required" >
            ...
            jQuery('.form-wizard-next-btn').click(function() {
              ...
              parentFieldset.find('.wizard-required').each(function(){
                ...
                if (thisName != undefined) {
                  var thisValue = jQuery(`#${thisName}`).val();
                  console.log(thisName, thisValue);
                  if( thisValue == "") {
                    var nama = $(`#${thisName}`).attr('nama');
                    // error(nama)
                    jQuery(`.${thisName}_error`).html(`<i class="fa fa-exclamation"></i> ${nama} belum diisi`).slideDown();
                    nextWizardStep = false;
                  } else {
                    jQuery(`.${thisName}_error`).html(``).slideDown();
                  }
                }
...
$('#id_kategori_jenis_pangan').change(function(){
  ...
  $.ajax({
    ...
    success:function(response){
      ...
      {
       html += `<option value="${data[i].id_jenis_pangan}" data-desc="${data[i].deskripsi}">${data[i].nama_jenis_pangan}</option>`;  
     }
      ...
      $('#id_jenis_pangan').change(function(){
        const desc = $('#id_jenis_pangan option:selected').data('desc');
          $('#show-deskripsi-jenis-pangan').html(`
            ...
            <textarea name="deskripsi_jenis_pangan" disabled class="form-control wizard-required" nama="Deskripsi Jenis Pangan" id="deskripsi_jenis_pangan">${desc}</textarea>
