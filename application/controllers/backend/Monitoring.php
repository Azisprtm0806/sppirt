...
$this->provinsi_model = new GeneralModel("tb_provinsi");
	...
	function getData($jenis = null)
	{
		...
		$query = [
			...
			'select' => 'tb_pengajuan_sppirt.id_pengajuan, no_sppirt, nama_jenis_pangan, nama_produk_pangan,nama_kemasan, id_izin,tb_pengajuan_sppirt.created_at as tgl_pengajuan, status_pengajuan, status_verifikasi, tb_kategori_jenis_pangan.*, no_sppirt_lama, status_no_sppirt, status_sinkronisasi, id_kota,id_prov, tb_user.nib',
			'where' => $where,
			'join' => [
