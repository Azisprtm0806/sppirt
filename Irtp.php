...
class Irtp extends CI_Controller
{
	...
	function getData($status)
	{
		if ($this->input->is_ajax_request()) {
			...
			$query = [
				...
				tb_user.id_prov, 
				tb_user.id_kota, 
				tb_kategori_jenis_pangan.nama_kategori_jenis_pangan, 
				tb_jenis_kemasan.nama_kemasan, 
				tb_penyimpanan.cara_penyimpanan, 
				tb_jenis_pangan.nama_jenis_pangan ',
				'where' => $where,
				'join' => [
 ...
 //  				  	';
	...
	function cetak($id_pengajuan)
	{
		...
		$this->db->select('*, tb_pengajuan_sppirt.created_at as tahun, tb_pengajuan_sppirt.nomor_izin, tb_user.id_prov, tb_user.id_kota')
	...
	public function exportexcel()
	{
		...
		$excel->getActiveSheet()->getColumnDimension('I')->setWidth(44);
